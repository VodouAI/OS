# Scripts & Background Jobs Guide - Complete Reference

## What are Scripts in Vodou?
...
```bash
# Note: Script intents require tool_parameters with server_name and script_name
# This is best done via database insertion (see above)
```
...
INSERT INTO script_registry (
    ...
    'my-project', 'learn', 'npm run learn',
...
```sql
INSERT INTO intent_mappings (
    intent_keyword, server_name, tool_name, priority, tool_parameters
) VALUES (
