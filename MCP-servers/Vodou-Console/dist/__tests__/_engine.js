 ...
 * another platform.
 */
export function findEngine(args, mustMatch) {
...
export function announceEngineSkip(suite, needs) {
    console.error(`[${suite}] SKIPPED: no vodou-core in this tree can run \`${needs}\`.\n` +
