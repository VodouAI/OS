        ...
        <div class="integration-section">
          ...
          <div class="int-cards">
            ${this._intCard('🖱️', 'Cursor', 'Add as a custom OpenAI-compatible provider in Cursor settings.', [
              ...
              `Add custom model: ${window.location.origin}/v1`,
              'Model name: vodou'
            ], null, 'code', 'cursor')}
            ...
            ${this._intCard('🤖', 'aider', 'AI pair programming in your terminal.', [
              ...
              `aider --openai-api-base ${window.location.origin}/v1 --model vodou`
            ], null, 'code', 'aider')}
            ${this._intCard('🔗', 'Any OpenAI SDK', 'Python, Node, or curl — anything that speaks OpenAI.', [
              `Set OPENAI_BASE_URL=${window.location.origin}/v1`,
...
# Run with Vodou
aider --openai-api-base ${window.location.origin}/v1 \\
