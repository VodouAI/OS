...
const ScriptsView = {
  ...
  _showOutput(scriptName, result) {
    ...
    if (container) {
      ...
      // The panel appends at the bottom of a potentially long page; bring it
      // into view so clicking Run gives visible feedback instead of "nothing".
      try { panel.scrollIntoView({ behavior: 'smooth', block: 'nearest' }); } catch (_) { panel.scrollIntoView(); }
    }
  },
