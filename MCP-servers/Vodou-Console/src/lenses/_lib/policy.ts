...
async function perHostThrottle(url: string): Promise<void> {
  let host = '';
 ...
 */
export async function policyFetch(url: string, init: RequestInit = {}, opts: PolicyOpts = {}): Promise<PolicyResult> {
