...
export class TemplateChannel {
     ...
     */
    async deliver(incoming, attachments) {
        this.lastActivity = new Date();
        const msg = attachments?.length ? { ...incoming, attachments } : incoming;
...
const _typecheck = new TemplateChannel();
void _typecheck;
