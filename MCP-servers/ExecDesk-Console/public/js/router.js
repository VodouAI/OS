...
const Router = {
  ...
  _updateNavActive(pathOnly, qs, raw) {
    ...
    if (pathOnly === '/capabilities' || pathOnly.startsWith('/servers')) {
    ...
    if (pathOnly === '/builder' || pathOnly.startsWith('/builder/') || pathOnly === '/terminal' || pathOnly === '/docs') {
