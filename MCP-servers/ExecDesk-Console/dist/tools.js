...
Pass server name, tool name, and optional arguments.`,
    ...
    },
    {
        ...
        description: "List MCP servers and tools from the local vodou-core.db cache (instant). Use to discover capabilities without connecting to remotes. Refresh **Capabilities → MCP Servers** (or run `./vodou-core all-tools` once) if the list looks stale.",
        input_schema: {
            type: "object",
            properties: {}
        }
