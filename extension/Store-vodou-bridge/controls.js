...
function vodouActivityLog(opts) {
  ...
  function describe(e) {
    ...
    // This build logs only 'nothing' | 'inserted' | 'clipboard'. The other two
    // branches are kept because this file is shared verbatim across builds, and
    // reworded: the old text said "invisibly, inside your message", describing a
    // capability this build does not have, in a panel anyone can open.
    switch (e.status) {
      case 'injected':
