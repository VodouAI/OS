...
test('chatgpt: conversation snapshot — last completed exchange only, deduped on refetch', () => {
  ...
  assert.deepEqual(wire(r.turns), [
    // E12 (703d235e): turns carry the provider's own timestamp. This fixture's
    // create_time 3 / 4 are fake epoch seconds (1970) — below vodouTurnTime's
    // plausibility floor (2000-01-01) — so they surface as null, not as a
    // backdated 1970 stamp. The Claude case below has real dates and shows the
    // populated shape.
