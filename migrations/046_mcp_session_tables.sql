-- Migration 046: mcp_sessions and mcp_session_calls tables
-- Previously created by Vodou-session-manager TypeScript on startup.
-- Now owned by Rust daemon migration system.
-- Uses IF NOT EXISTS for safety on existing installs.
