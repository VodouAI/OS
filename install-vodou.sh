...
echo "══════════════════════════════════════"
echo ""
echo "Next step — start Vodou (opens onboarding in your browser):"
echo ""
echo "     cd $INSTALL_DIR && ./start-vodou-services.sh"
echo ""
echo "Onboarding walks you through the rest. If the browser doesn't open,"
echo "go to http://localhost:8765"
echo ""
